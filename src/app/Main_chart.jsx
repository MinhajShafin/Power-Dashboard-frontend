      ...
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            disabled={refreshing}
            className="flex items-center justify-center w-10 h-10 rounded-lg border border-border bg-background hover:bg-accent disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
